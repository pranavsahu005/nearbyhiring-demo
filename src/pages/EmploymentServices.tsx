          ...
          <div className="max-w-4xl mx-auto">
            <div className="mb-24 text-center" data-reveal>
              ...
              <div className="flex flex-col items-center gap-2">
                <p className="text-slate-500 font-bold text-lg">Eduskill Employment Division (Eduskill Technologies Private Limited)</p>
                <div className="px-4 py-1 bg-blue-600 text-white rounded-full text-xs font-black uppercase tracking-widest mt-2">
            ...
            <div className="space-y-16">
              ...
              {/* Scope */}
              <section className="bg-blue-900 p-12 md:p-20 rounded-[5rem] text-white relative overflow-hidden" data-reveal>
              ...
              {/* Prohibition */}
              <section className="bg-white p-12 md:p-20 rounded-[5rem] shadow-2xl border border-slate-100" data-reveal>
                <div className="flex items-center gap-6 mb-12">
                  <div className="h-16 w-16 bg-red-50 rounded-3xl flex items-center justify-center text-red-600 shadow-inner">
                    <AlertTriangle className="h-8 w-8" />
                  </div>
                  <h2 className="text-3xl font-black text-slate-900 uppercase italic tracking-tight">Prohibition & Reporting</h2>
                </div>
                <div className="prose prose-slate max-w-none text-slate-600 leading-relaxed space-y-8 text-lg font-medium">
                  <p>
              ...
              <div className="bg-white rounded-[5rem] p-12 md:p-20 border border-slate-100 shadow-xl overflow-hidden group" data-reveal>
                <div className="flex flex-col md:flex-row items-center gap-12">
                   <div className="flex-1 space-y-6">
                      <h3 className="text-3xl font-black text-slate-900 uppercase italic tracking-tight">Report a Violation</h3>
